...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css2/dataTables.bootstrap.css"/>
    <link rel="stylesheet" href="css2/custom.css"/>
    <script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
  </head>
  <body style="background-color: #f8f9fa;">
      
    <nav class="navbar navbar-default navbar-fixed-top navbar-premium" role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="home">
            <i class="fa fa-life-ring" style="color: #ea7048; margin-right: 5px;"></i> 
            GORONTALO<span style="color: #333;">DIVE</span>
          </a>
        </div>
