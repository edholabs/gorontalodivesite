<?php
    ...
    if ( !empty($_POST))
    {
        ...
        $query = "Delete from divedata where Id_dive=$Id";
...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="parent ">
                <a href="#">
                    <span data-toggle="collapse" href="#sub-item-1"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Manajemen divesite
                </a>
                <ul class="children collapse" id="sub-item-1">
                    <li>
                        <a class="" href="tabeldivesite.php">
                            <svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Data divesite
                        </a>
                    </li>
                    <li>
                        <a class="" href="inputdivesite.php">
                            <svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Input divesite
                        </a>
                    </li>
                </ul>
            </li>
...
<div class="container">
    <div class="row">
		...
		<form method="POST" action="hapusdivesite.php">
			<input type="hidden" name="Id_dive" value="<?php echo $Id;?>" />
			<p class="bg-danger" style="padding: 10px;">Apakah anda ingin menghapus data ini?</p>
			<div class="form-actions">
				<button type="submit" class="btn btn-danger">Ya</button>
				<a class="btn btn btn-default" href="tabeldivesite.php">Tidak</a>
			</div>
		</form>
