<?php
    ...
    if ( !empty($_POST))
    {
        ...
        $query = "Delete from datakota where Id_kota=$Id";
...
<div class="container">
    <div class="row">
		...
		<form method="POST" action="hapuskota.php">
			<input type="hidden" name="Id_kota" value="<?php echo $Id;?>" />
			<p class="bg-danger" style="padding: 10px;">Apakah anda ingin menghapus data ini?</p>
			<div class="form-actions">
				<button type="submit" class="btn btn-danger">Ya</button>
				<a class="btn btn btn-default" href="tabelkota.php">Tidak</a>
			</div>
		</form>
