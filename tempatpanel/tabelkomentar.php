            ...
            <div class="panel-body">
              ...
              <thead>
				...
				<?php
					...
					$query  = "select * from comment order by Id_comment limit 1000";
					...
					while($row=mysqli_fetch_array($res)){
						...
						echo '<td>'. $row['date'] . '</td>';
						echo '<td><a class="btn btn-xs btn-danger" href="hapuskomentar.php?Id_comment='. $row['Id_comment'] . '">Delete</a>
