...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-1"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Manajemen Dive Site
				</a>
				<ul class="children collapse" id="sub-item-1">
					<li>
						<a class="" href="tabeldivesite.php">
							<svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Data Dive Site
						</a>
					</li>
					<li>
						<a class="" href="inputdivesite.php">
							<svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Input Dive Site
						</a>
					</li>
				</ul>
			</li>
			...
			<li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-2"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Manajemen Kota Gorontalo
				</a>
						...
						<div class="col-md-6">
							<form role="form">
								...
								<div class="form-group">
									...
									<textarea class="mce" id="inputkonten" value="<?php echo !empty($konten)?$konten:'';?>" name="Konten" placeholder="" ></textarea>
								</div>
